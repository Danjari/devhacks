                ...
                properties: { 
                    ...
                    data: { 
                        ...
                        properties: { 
                            ...
                            type: { 
                                type: "string", 
                                enum: ["Content", "Assignment", "Assessment", "Resource", "Quiz"] 
                            }, 
                            icon: { type: "string" }, 
                            description: { type: "string" }, 
                            resources: { 
    ...
    try { 
        ...
        const completion = await openai.chat.completions.create({ 
            ...
            messages: [ 
                { 
                    role: "system", 
                    content: `You are an AI assistant that generates learning pathways based on user prompts and custom data. Respond with a complete, valid JSON object representing the learning pathway. Each node should have a unique id, data (including label, type, icon, description, and optional resources), and an array of parent node ids to represent relationships. The first node should have an empty parents array. Use emojis for icons. Types can be: Content, Assignment, Assessment, Resource, or Quiz. Create a logical progression of topics, including branching paths if appropriate. Incorporate insights from the custom data provided.` 
                }, 
                { 
                    role: "user", 
